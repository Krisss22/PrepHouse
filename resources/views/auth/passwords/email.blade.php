...
<div class="container auth-page-container">
    <div class="auth-page-logo-block">
        ...
        <div class="auth-page-logo-block-text">PREPHouse</div>
    </div>

    <div class="auth-page-main-block">
        <div class="auth-page-main-block-top">
            <div class="auth-page-main-block-top-lable">Forgot password</div>
            <div class="auth-page-main-block-top-sign-up"><a href="{{ route('login') }}">Back to Log In</a></div>
        </div>
        <form class="auth-page-main-block-form auth-page-reset-password-form" method="POST" action="{{ route('password.email') }}">
            @csrf
            @if (session('status'))--}}
            ...
            @endif
            <div class="form-row"><div class="auth-form-reset-password-description">Please enter your email to reset password</div></div>
            <div class="form-row">
                <label>Email @error('email')<span class="invalid-feedback" role="alert">{{ $message }}</span>@enderror</label>
                <input id="email" type="email" class="@error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            </div>
            <div class="form-row">
                <button type="submit" class="auth-page-main-block-form-submit-button">Request Password Reset</button>
            </div>
        </form>
    </div>
</div>
