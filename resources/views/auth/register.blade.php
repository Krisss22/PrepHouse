...
<div class="container auth-page-container">
    ...
    <div class="auth-page-main-block">
        <div class="auth-page-main-block-top">
            <div class="auth-page-main-block-top-lable">Sign Up</div>
            <div class="auth-page-main-block-top-sign-up">Already have an account? <a href="{{ route('login') }}">Log In</a></div>
        </div>
