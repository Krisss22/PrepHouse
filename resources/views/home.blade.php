...
@section('content')
    <div class="home-head-block">
        <div class="home-menu-block">
            ...
            <div class="menu">
                <a href="/quizzes-list" class="menu-item">
            ...
            <div class="home-head-content-left-block">
                ...
                <div class="home-head-content-left-buttons-block">
                    <a class="home-head-content-left-start-quiz-button">
                        <div class="home-head-content-left-start-quiz-button-svg">
                            <svg width="40" height="41" viewBox="0 0 40 41" fill="none"
                                ...
                                <path
                                    d="M17.2244 13.6258C16.4149 13.1712 15.3953 13.4682 14.947 14.2892C14.8095 14.5411 14.7373 14.8244 14.7373 15.1123V26.8298C14.7373 27.7682 15.4874 28.529 16.4128 28.529C16.6968 28.529 16.9761 28.4558 17.2246 28.3162L27.6557 22.4567C28.4652 22.002 28.7579 20.9679 28.3096 20.147C28.1572 19.868 27.9306 19.6382 27.6555 19.4837L17.2244 13.6258Z"
                                    fill="#F7B631"/>
                            </svg>
                        </div>
                    ...
                    <a href="/share-question" class="home-head-content-left-share-question-button">
                        ...
                        <div data="record-data" class="home-head-content-left-share-question-button-text">
                            @if(Controller::isOriginSite())
                                Share question
                            @else
                                Ask a question
    ...
    <div class="home-middle-block">
        ...
        <div class="home-middle-block-lectures-block">
            ...
            <a data="record-data" class="home-middle-block-lectures-block-button"><p>
                    @if(Controller::isOriginSite())
                        View all Lectures
                    @else
                        Schedule your demo
